...
import { ToggleButton } from "../exercise6/ThemeToggle";
import { useTheme } from "../exercise6/BackgroundTheme";
...
export default function QuizScreen(){
    ...
    const handleNextClickDisplayQuiz = async (usersAnswer: any) => {
        ...
        if(quizData[quizIndex] && quizData[quizIndex].correct_answer === usersAnswer) {
            setDisplayAnswer("Correct Answer!");
            setCorrectAnswerIncrementor(prev => prev+1);
            setIsCorrect(true);
        }
        else{
            setDisplayAnswer("Wrong Answer!");
                            ...
                            {isLoading ? (
                                <Text style={{
                                    ...
                                    { quizData.length <= 0 ? (
                                        ...
                                        <Text style={{
                                            ...
                                            textAlign: "center"
                                        }}>Pick a number between 10 - 30 random questions</Text>
                                ...
                                //   if quiz data has a value will render this part
                                    ...
                                    {currentQuizData && quizIndex < quizData.length ?  (
                                        ...
                                        transitionDuration: theme.transition,
                                        fontWeight: "bold",
                                        }}>{`${correctAnswerIncrementor} Correct answers`}</Text>
                                        ...
                                        transitionDuration: theme.transition,
                                        fontWeight: "bold",
                                        }}>{`${inCorrectAnswerIncrementor} Incorrect answers`}</Text>
